...
Chitest_N_inv <- table(Full_20082015$WAVE, Full_20082015$Neigh_involve)
chisq.test(Chitest_N_inv)

Chitest_Volunteer <- table(Full_20082015$WAVE, Full_20082015$Volunteering)
...
##List variables to be used: Age, Gender, Household, Ethnicity, Tenure, Adress_years

## Nullmodels, compare fit
# Neigh_involve

Model0 <- glm(Neigh_involve ~ 1, data = Full_20082015,family = binomial(link="logit"))
summary(Model0)
...
Model0F <- glmer(Neigh_involve ~ (1|Neigh_SES) + (1|Wijk71)+ (1|WAVE) , data = Full_20082015,family = binomial(link="logit"))
summary(Model0F)
