...
table(Full_20082015A$Spline1, exclude = NULL)
...
Full_20082015A$predictModel5splA <- predict(Model5splA, type = "response", newdata = NULL)

Predictplot <- ggplot(Full_20082015A, aes(x=factor(WAVE), y=predictModel5splA, group=Neigh_SES_5, colour = factor(Neigh_SES_5),shape = factor(Neigh_SES_5)))
Predictplot + stat_summary(fun.y=mean, geom="line")+ stat_summary(fun.y=mean, geom = "point")+ expand_limits(y=c(0.15,0.35))
