...
Context2008 <- read.csv("C:/Data Mattheus 2.0/Buurtdata context 2008.csv", sep = ";")
...
Context2009 <- read.csv("C:/Data Mattheus 2.0/Buurtdata context 2009.csv", sep = ";")
...
Context2010 <- read.csv("C:/Data Mattheus 2.0/Buurtdata context 2010.csv", sep = ";")
...
Context2011 <- read.csv("C:/Data Mattheus 2.0/Buurtdata context 2011.csv", sep = ";")
...
summary(Full_20082015a$Neigh_involve)
describe(Full_20082015a$Neigh_involve)

Full_20082015a <- Full_20082015a %>% group_by(Wijk71,WAVE) %>% mutate(Neigh_inv_mean_unw = mean(Neigh_involve, na.rm=TRUE))

?mutate

table(Full_20082015a$Neigh_inv_mean_unw)
describe(Full_20082015a$Neigh_inv_mean_unw)
summary(Full_20082015a$Neigh_inv_mean_unw)

ggplot(Full_20082015a, aes(x = WAVE, y = Neigh_inv_mean_unw)) + geom_point()

ggplot(Full_20082015a, aes(x = factor(WAVE), y = Neigh_inv_mean_unw)) + geom_boxplot()

ggplot(Full_20082015a, aes(x = factor(WAVE), y = Neigh_inv_mean_unw, colour = Low_40)) + geom_point()
