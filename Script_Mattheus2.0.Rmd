...
Full_20082013$Perc_N_inv <- NA
Full_20082013$Perc_N_inv[Full_20082013$WAVE==2008] <- 0.2357796
Full_20082013$Perc_N_inv[Full_20082013$WAVE==2009] <- 0.2326045
Full_20082013$Perc_N_inv[Full_20082013$WAVE==2010] <- 0.2304046
Full_20082013$Perc_N_inv[Full_20082013$WAVE==2011] <- 0.2337748 
Full_20082013$Perc_N_inv[Full_20082013$WAVE==2013] <- 0.2339587
#Full_20082013$Perc_N_inv[Full_20082013$WAVE==2013] <- 0.2749579

Full_20082013$Perc_N_inv_w <- NA
Full_20082013$Perc_N_inv_w[Full_20082013$WAVE==2008] <- 0.2266144
Full_20082013$Perc_N_inv_w[Full_20082013$WAVE==2009] <- 0.2262049
Full_20082013$Perc_N_inv_w[Full_20082013$WAVE==2010] <- 0.2183327
Full_20082013$Perc_N_inv_w[Full_20082013$WAVE==2011] <- 0.2194426 
Full_20082013$Perc_N_inv_w[Full_20082013$WAVE==2013] <- 0.2164532
...
Full_20082013$Perc_Volunteer <- NA
Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2008] <- 0.2304545 
Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2009] <- 0.2379408
Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2010] <- 0.2326607
Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2011] <- 0.2178457 
Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2013] <- 0.2213054
#Full_20082013$Perc_Volunteer[Full_20082013$WAVE==2013] <- 0.2462245

Full_20082013$Perc_Volunteer_w <- NA
Full_20082013$Perc_Volunteer_w[Full_20082013$WAVE==2008] <- 0.219716 
Full_20082013$Perc_Volunteer_w[Full_20082013$WAVE==2009] <- 0.2279223
Full_20082013$Perc_Volunteer_w[Full_20082013$WAVE==2010] <- 0.2266389
Full_20082013$Perc_Volunteer_w[Full_20082013$WAVE==2011] <- 0.2118029 
Full_20082013$Perc_Volunteer_w[Full_20082013$WAVE==2013] <- 0.2132327
...
#Full_20082013.long2 <- melt(Full_20082013, id = "WAVE", measure = c("Perc_N_inv","Perc_Volunteer"))
#Fig1 <- ggplot(Full_20082013.long2, aes(WAVE, value, group=variable))
#Fig1 + geom_line(aes(linetype=variable), position=position_dodge(0.15)) + expand_limits(y=c(0.175,0.3)) + geom_point(aes(shape=variable),position=position_dodge(0.15), size=2.5) + scale_x_continuous(breaks = c(2008,2009,2010,2011,2012,2013)) + xlab("Year of survey") + ylab("% Civic participation")+ theme_bw() + labs(shape="Civic participation", linetype="Civic participation") + scale_shape_discrete(labels = c("Neighbourhood involvement","Volunteering"))+  scale_linetype_discrete(labels = c("Neighbourhood involvement","Volunteering"))

## factor analysis neighbourhood SES + save scores

fa <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = Full_20082013, scores = "regression")
fa

Full_20082013 <- cbind(Full_20082013, fa$scores)
Full_20082013$Neigh_SES <- 0 - Full_20082013$Factor1

# Test Factor
#d <- data.frame(Low40=Full_20082013$Low_40,Disp=Full_20082013$Disposable_income,Unemp=Full_20082013$Perc_unemployed,Benef=Full_20082013$Perc_benefits, factor=Full_20082013$Neigh_SES)
#cor(d)

#Cronbach's alpha
library(psych)

d1 <- data.frame(Low40=Full_20082013$Low_40, Disp=Full_20082013$Disposable_income,Unemp=Full_20082013$Perc_unemployed,Benef=Full_20082013$Perc_benefits)
alpha(d1, keys = c("Disp"))

d2 <- data.frame(read=Full_20082013$Dutch_read,speak=Full_20082013$Dutch_speak,write=Full_20082013$Dutch_write)
alpha(d2)

library(Hmisc)

Full_20082013$Dutch_prof <- (Full_20082013$Dutch_read + Full_20082013$Dutch_speak+Full_20082013$Dutch_write)/3
describe(Full_20082013$Dutch_prof)
...
##for 2008-2013: 1005 respondents excluded (out of 65486)

Full_20082013A <- drop_na(Full_20082013, Neigh_involve, Volunteering,Age, Male, Household, Ethnicity, Tenure, Educ_ordinal, Labour_status, Health, Dutch_prof)

# create Neighbourhood-Year unique value. number of unique values: 422
# for: 2018-2013: ...
Full_20082013A$Neigh_year <- Full_20082013A$WAVE/100000 + Full_20082013A$Wijk71/10000
#describe(Full_20082013A$Neigh_year)

# rescale Wijk71 and WAVE
Full_20082013A$Wijk71_sc <- Full_20082013A$Wijk71/10000
#describe(Full_20082013$Wijk71_sc)

Full_20082013A$WAVE_sc <- Full_20082013A$WAVE/10000
#describe(Full_20082013$WAVE_sc)


##dummies for descriptives
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$WAVE, sep = "_"))
Full_20082013A$Educ_ordinal1 <- as.numeric(Full_20082013A$Educ_ordinal)
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$Educ_ordinal1, sep = ":"))
Full_20082013A$Educ_ordinal1 <- as.numeric(Full_20082013A$Educ_ordinal)
Full_20082013A$Male_num <- as.numeric(Full_20082013A$Male)
Full_20082013A$Household1 <- as.numeric(Full_20082013A$Household)
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$Household1, sep = "-"))
Full_20082013A$Ethnicity1 <- as.numeric(Full_20082013A$Ethnicity)
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$Ethnicity1, sep = "="))
Full_20082013A$Tenure1 <- as.numeric(Full_20082013A$Tenure)
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$Tenure1, sep = "+"))

# group economically inactive
Full_20082013A$Labour_status4 <- recode(Full_20082013A$Labour_status,"'Student' = 'Inactive'; 'Household' = 'Inactive';'Retired' = 'Inactive';'Volunteer/Other' = 'Inactive'")
Full_20082013A$Labour_status4 <- relevel(Full_20082013A$Labour_status4, ref = "Works>12h")

Full_20082013A$Labour_status41 <- as.numeric(Full_20082013A$Labour_status4)
Full_20082013A <- cbind(Full_20082013A, dummy(Full_20082013A$Labour_status41, sep = "^"))

## Mean-center contextual variables

Full_20082013A$Herf_div_mean <- Full_20082013A$Herf_div - mean(Full_20082013A$Herf_div, na.rm = TRUE)
Full_20082013A$Turnover_mean <- Full_20082013A$Turnover - mean(Full_20082013A$Turnover, na.rm = TRUE)

## Mean-center Age + create Age-square, Health + Dutch_prof

Full_20082013A$Age_2 <- Full_20082013A$Age^2
Full_20082013A$Age_mean <- Full_20082013A$Age - mean(Full_20082013A$Age, na.rm=TRUE)
Full_20082013A$Age_mean_sc <- Full_20082013A$Age_mean/10
Full_20082013A$Age_2_mean <- Full_20082013A$Age_2 - mean(Full_20082013A$Age_2, na.rm=TRUE)
Full_20082013A$Age_2_mean_sc <- Full_20082013A$Age_2_mean/1000


Full_20082013A$Health_mean <- Full_20082013A$Health - mean(Full_20082013A$Health, na.rm=TRUE)
Full_20082013A$Dutch_prof_mean <- Full_20082013A$Dutch_prof - mean(Full_20082013A$Dutch_prof, na.rm=TRUE)

## with contextuals as dummies

Full_20082013A <- Full_20082013A %>% group_by(WAVE) %>% mutate(Neigh_SES_5= ntile(Neigh_SES, 5))
...
# first spline: small changes 2008-2009
Full_20082013A$Spline1 <- 0
Full_20082013A$Spline1[Full_20082013A$WAVE==2008] <- 1
...
Full_20082013A$Spline2a <- 0
Full_20082013A$Spline2a[Full_20082013A$WAVE==2009] <- 0
Full_20082013A$Spline2a[Full_20082013A$WAVE==2010] <- 1
Full_20082013A$Spline2a[Full_20082013A$WAVE==2011] <- 2
Full_20082013A$Spline2a[Full_20082013A$WAVE==2013] <- 3
...
#Model2NI <- glmer(Neigh_involve ~ (1|Neigh_year) + (1|Wijk71_sc)+ (1|WAVE_sc) + Labour_status, data = Full_20082015B, family = binomial(link = "logit"), nAGQ = 0)
#summary(Model2NI)

#Model2V <- glmer(Volunteering ~ (1|Neigh_year) + (1|Wijk71_sc)+ (1|WAVE_sc) + Labour_status, data = Full_20082015B, family = binomial(link = "logit"), nAGQ = 0)
#summary(Model2V)
...
#Model2_NI <- glmer(Neigh_involve ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a, data = Full_20082013A,family = binomial(link="logit"))


#Model3_NI <- glmer(Neigh_involve ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a + Spline2a:Neigh_SES, data = Full_20082013A,family = binomial(link="logit"))


### Volunteering

#Model2_V <- glmer(Volunteering ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a, data = Full_20082013A,family = binomial(link="logit"))


#Model3_V <- glmer(Volunteering ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a + Spline2a:Neigh_SES, data = Full_20082013A,family = binomial(link="logit"))


Full_20082013A$Neigh_involve_num <- as.numeric(Full_20082013A$Neigh_involve) - 1

#aggregate(Neigh_involve_num ~ Labour_status4 + WAVE, data = Full_20082013A, FUN = mean)
#aggregate(Neigh_involve_num ~ Household, data = Full_20082013A, FUN = mean)

#aggregate(Volunteering ~ Labour_status4, data = Full_20082013A, FUN = mean)
#aggregate(Neigh_involve_num ~ Household, data = Full_20082013A, FUN = mean)

#Model <- glmer(Volunteering ~ (1|Neigh_year) + (1|Wijk71)+ (1|WAVE) +Labour_status4, data = Full_20082013A,family = binomial(link="logit"))
#summary(Model)


Model2_NIa <- glmer(Neigh_involve ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status4 + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a, data = Full_20082013A,family = binomial(link="logit"), nAGQ = 0)
summary(Model2_NIa)

Model3_NIa <- glmer(Neigh_involve ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status4 + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a + Spline2a:Neigh_SES, data = Full_20082013A,family = binomial(link="logit"), nAGQ = 0)
summary(Model3_NIa)

Model2_Va <- glmer(Volunteering ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status4 + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a, data = Full_20082013A,family = binomial(link="logit"), nAGQ = 0)
summary(Model2_Va)

Model3_Va <- glmer(Volunteering ~ (1+Spline2a|Neigh_SES) + (1|Wijk71_sc)+ (1|WAVE_sc) + Educ_ordinal +  Labour_status4 + Age_mean_sc + Age_2_mean_sc + Male + Household + Ethnicity + Tenure +  Health_mean + Dutch_prof_mean + Neigh_SES + Herf_div_mean + Turnover_mean + Spline1 + Spline2a + Spline2a:Neigh_SES, data = Full_20082013A,family = binomial(link="logit"), nAGQ = 0)
summary(Model3_Va)
...
Full_20082013A$predict_Model3_NIa <- predict(Model3_NIa, type = "response", newdata = NULL)

Full_20082013A$Spline2aplot <-Full_20082013A$Spline2a 
Full_20082013A$Spline2aplot[Full_20082013A$Spline2a==3] <- 4

Predictplot_NI <- ggplot(Full_20082013A, aes(x=Spline2aplot, y=predict_Model3_NIa, group=Neigh_SES_5, linetype = factor(Neigh_SES_5)))
Predictplot_NI + stat_summary(fun.y=mean, geom="line")+ stat_summary(fun.y=mean, geom="point") +stat_summary(fun.data = mean_cl_normal, geom = "linerange")+ expand_limits(y=c(0.15,0.35)) + xlab("Year of survey") + ylab("Predicted prob. neighbourhood involvement")+ theme_bw() + labs(linetype="Neighbourhood SES\n(quintiles)") + scale_x_continuous(breaks = c(0,1,2,3,4),labels = c("2009","2010","2011","2012","2013")) + guides(linetype=guide_legend(reverse = TRUE))

#aggregate(predict_Model3_NIa ~ Spline2a + Neigh_SES_5,data = Full_20082013A, FUN=mean)
#0.1938202 -  0.2197004
#0.2828357 -  0.2622455

Full_20082013A$predict_Model3_Va <- predict(Model3_Va, type = "response", newdata = NULL)

Predictplot_V <- ggplot(Full_20082013A, aes(x=Spline2aplot, y=predict_Model3_Va, group=Neigh_SES_5, linetype = factor(Neigh_SES_5)))
Predictplot_V + stat_summary(fun.y=mean, geom="line")+ stat_summary(fun.y=mean, geom="point") +stat_summary(fun.data = mean_cl_normal, geom = "linerange")+ expand_limits(y=c(0.15,0.35))+ xlab("Year of survey") + ylab("Predicted prob. volunteering")+ theme_bw() + labs(linetype="Neighbourhood SES\n(quintiles)") + scale_x_continuous(breaks = c(0,1,2,3,4),labels = c("2009","2010","2011","2012","2013")) + guides(linetype=guide_legend(reverse = TRUE))

#aggregate(predict_Model3_Va ~ Spline2a + Neigh_SES_5,data = Full_20082013A, FUN=mean)
#0.3015945 - 0.2533663
...
#plot_age <- ggplot(Full_20082013A, aes(x=Age, y=predict_Model3_NIa))
#plot_age + stat_summary(fun.y=mean, geom="line") 

#plot_age2 <- ggplot(Full_20082013A, aes(x=Age, y=predict_Model3_Va))
#plot_age2 + stat_summary(fun.y=mean, geom="line") 
...
descriptive.table(vars = d(Volunteering,Neigh_involve_num,`Full_20082013A:1`,`Full_20082013A:2`,`Full_20082013A:3`,`Full_20082013A:4`,`Full_20082013A:5`,`Full_20082013A^1`,`Full_20082013A^2`,`Full_20082013A^3`,`Full_20082013A^4`,Age, Age_2,Male_num,`Full_20082013A-1`,`Full_20082013A-2`,`Full_20082013A-3`,`Full_20082013A-4`,`Full_20082013A-5`,`Full_20082013A=1`,`Full_20082013A=2`,`Full_20082013A=3`,`Full_20082013A=4`,`Full_20082013A=5`,`Full_20082013A=6`,`Full_20082013A=7`,`Full_20082013A+1`,`Full_20082013A+2`,`Full_20082013A+3`, Health, Dutch_prof, Neigh_SES, Herf_div_mean , Turnover_mean), data =Full_20082013A, func.names = c("Mean","St. Deviation", "Minimum","Maximum","Valid N"))
...
G_neigh <- ggplot(Full_20082013A, aes(x=WAVE, y=Neigh_involve_num, group=Neigh_SES_5, linetype = factor(Neigh_SES_5),shape = factor(Neigh_SES_5))) 
G_neigh + stat_summary(fun.y=mean,position = position_dodge(0.15), geom="line")+ stat_summary(fun.y=mean,position = position_dodge(0.15), geom = "point")+ expand_limits(y=c(0.15,0.35))+ scale_x_continuous(breaks = c(2008,2009,2010,2011,2012,2013))+ labs(x="Year of survey",y="% Neighbourhood involvement",shape="Neighbourhood SES\n(quintiles)", linetype="Neighbourhood SES\n(quintiles)") + guides(shape=guide_legend(reverse = TRUE), linetype=guide_legend(reverse = TRUE)) + theme_bw()
...
Full_20082013A$Volunteering_num <- as.numeric(Full_20082013A$Volunteering)

G_vol <- ggplot(Full_20082013A, aes(x=WAVE, y=Volunteering_num, group=Neigh_SES_5, linetype = factor(Neigh_SES_5),shape = factor(Neigh_SES_5))) 
G_vol + stat_summary(fun.y=mean,position = position_dodge(0.15), geom="line")+ stat_summary(fun.y=mean,position = position_dodge(0.15), geom = "point")+ expand_limits(y=c(0.15,0.35))+ scale_x_continuous(breaks = c(2008,2009,2010,2011,2012,2013))+ labs(x="Year of survey",y="% Volunteering",shape="Neighbourhood SES\n(quintiles)", linetype="Neighbourhood SES\n(quintiles)") + guides(shape=guide_legend(reverse = TRUE), linetype=guide_legend(reverse = TRUE)) + theme_bw()
...
Full_20082015a <- Full_20082015
Full_20082015a$Neigh_involve <- as.numeric(Full_20082015a$Neigh_involve) - 1

Full_20082015a <- Full_20082015a %>% group_by(WAVE,Labour_status) %>% mutate(Neigh_inv_LS = mean(Neigh_involve, na.rm=TRUE))
...
### check corrections factanal per year

 table(Full_20082013A$Neigh_SES_5, Full_20082013A$WAVE)
aggregate(Volunteering ~ WAVE  + Neigh_SES_5,data = Full_20082013A, FUN = "mean")

datatest <- Full_20082013A %>%  select(Volunteering, Neigh_involve, Neigh_SES, Neigh_SES_5, WAVE)
 

fa1 <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = data2008seldef, scores = "regression")
fa1

data2008seldef <- cbind(data2008seldef, fa1$scores)
data2008seldef$Neigh_SES <- 0 - data2008seldef$Factor1
data2008seldef <- data2008seldef %>%mutate(Neigh_SES_5= ntile(Neigh_SES, 5))


fa2 <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = data2009seldef, scores = "regression")
fa2

data2009seldef <- cbind(data2009seldef, fa2$scores)
data2009seldef$Neigh_SES <- 0 - data2009seldef$Factor1
data2009seldef <- data2009seldef %>%mutate(Neigh_SES_5= ntile(Neigh_SES, 5))

fa3 <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = data2010seldef, scores = "regression")
fa3

data2010seldef <- cbind(data2010seldef, fa3$scores)
data2010seldef$Neigh_SES <- 0 - data2010seldef$Factor1
data2010seldef <- data2010seldef %>%mutate(Neigh_SES_5= ntile(Neigh_SES, 5))

fa4 <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = data2011seldef, scores = "regression")
fa4

data2011seldef <- cbind(data2011seldef, fa4$scores)
data2011seldef$Neigh_SES <- 0 - data2011seldef$Factor1
data2011seldef <- data2011seldef %>%mutate(Neigh_SES_5= ntile(Neigh_SES, 5))

fa5 <- factanal(~Low_40+Disposable_income+Perc_unemployed+Perc_benefits, factors = 1, data = data2013seldef, scores = "regression")
fa5

data2013seldef <- cbind(data2013seldef, fa5$scores)
data2013seldef$Neigh_SES <- 0 - data2013seldef$Factor1
data2013seldef <- data2013seldef %>%mutate(Neigh_SES_5= ntile(Neigh_SES, 5))

Full_20082009e <- full_join(data2008seldef, data2009seldef)
Full_20082010e <- full_join(Full_20082009e, data2010seldef)
Full_20082011e <- full_join(Full_20082010e, data2011seldef)
Full_20082013e <- full_join(Full_20082011e, data2013seldef) 

Full_20082013eA <- drop_na(Full_20082013e, Neigh_involve, Volunteering,Age, Male, Household, Ethnicity, Tenure, Educ_ordinal, Labour_status, Health)


Full_20082013eA$Neigh_involve_num <- as.numeric(Full_20082013eA$Neigh_involve) - 1

G_neigh <- ggplot(Full_20082013eA, aes(x=WAVE, y=Neigh_involve_num, group=Neigh_SES_5, linetype = factor(Neigh_SES_5),shape = factor(Neigh_SES_5))) 
G_neigh + stat_summary(fun.y=mean,position = position_dodge(0.15), geom="line")+ stat_summary(fun.y=mean,position = position_dodge(0.15), geom = "point")+ expand_limits(y=c(0.15,0.35))+ scale_x_continuous(breaks = c(2008,2009,2010,2011,2012,2013))+ labs(x="Year of survey",y="% Neighbourhood involvement",shape="Neighbourhood SES (quintiles)", linetype="Neighbourhood SES (quintiles)") + guides(shape=guide_legend(reverse = TRUE), linetype=guide_legend(reverse = TRUE)) + theme_bw()

Full_20082013eA$Volunteering_num <- as.numeric(Full_20082013eA$Volunteering)

G_vol <- ggplot(Full_20082013eA, aes(x=WAVE, y=Volunteering_num, group=Neigh_SES_5, linetype = factor(Neigh_SES_5),shape = factor(Neigh_SES_5))) 
G_vol + stat_summary(fun.y=mean,position = position_dodge(0.15), geom="line")+ stat_summary(fun.y=mean,position = position_dodge(0.15), geom = "point")+ expand_limits(y=c(0.15,0.35))+ scale_x_continuous(breaks = c(2008,2009,2010,2011,2012,2013))+ labs(x="Year of survey",y="% Volunteering",shape="Neighbourhood SES (quintiles)", linetype="Neighbourhood SES (quintiles)") + guides(shape=guide_legend(reverse = TRUE), linetype=guide_legend(reverse = TRUE)) + theme_bw()
